...
// FixEight-local game instantiation. Derived from JTFrame's
...
u_game(
    ...
    // Main's MRA high-score transport bypasses the ROM/framework byte stream.
    ...
    .hs_ioctl_wr        ( hps_wr       ),
    .hs_ioctl_rd        ( hps_rd       ),
    .hs_ioctl_addr      ( hps_addr     ),
    .hs_ioctl_data      ( hps_dout     ),
...
`endif
    ...
    // FixEight save-state controller and state-bus slave.
    .ss_do_save       ( ss_save             ),
